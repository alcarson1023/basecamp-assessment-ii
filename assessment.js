...
// CODE HERE
message['text'] = 'You have one new message!'
...
var myFriends = ['Bridgette','Austin','Kyle','Ryan'];
...
function evensOnly(){
  ...
  console.log('Array is',typeof myNumbers,myNumbers)
for(i=0;i<myNumbers.length;i++){
  if(myNumbers[i]%2===0){
    evensArray.push(myNumbers[i]);
  }
};
console.log('oustide',evensArray)
return evensArray
};
evensOnly(myNumbers);
